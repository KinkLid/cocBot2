...
def test_capital_raid_attack_accepts_nested_and_legacy_attacker_tags() -> None:
                    ...
                    "districts": [
                        {
                            "attacks": [
                                {
                                    "attacker": {"tag": "#NESTED", "name": "Nested"},
                                    "destructionPercent": 73,
                                },
                                {
                                    "attackerTag": "#LEGACY",
                                    "destructionPercent": 41,
                                },
                            ]
                        }
                    ]
    ...
    assert season.destruction_by_player() == {
        "#NESTED": 73,
        "#LEGACY": 41,
    }
